    ...
    return (
        <div name="contact" className="w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white">
            ...
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/2e319e71-ae76-4c74-8d6c-8e474fff963c" method="POST" className="flex flex-col w-full md:w-1/2">
                    ...
                    rounded-md text-white focus:outline-none" />
                     <input type="email" name="name" placeholder="Enter your email" className="my-4 p-2 bg-transparent border-2
                    rounded-md text-white focus:outline-none" />
                ...
                flex items-centern rounded-md hover:scale-110 duration-300">Let's talk</button>
                </form>
            </div>
            </div>
            </div>
